...
(function() {
    ...
    var translations = {
        ...
        // === INDEX - MINI-DIAGNOSTIC CTA ===
        'OÙ EN ÊTES-VOUS AVEC VOTRE PROJET ?': 'WHERE ARE YOU WITH YOUR PROJECT?',
        'Répondez à 3 questions (2 min) — on vous oriente vers la solution adaptée.': 'Answer 3 questions (2 min) — we\'ll guide you to the right solution.',
        'FAIRE LE MINI-DIAGNOSTIC': 'TAKE THE MINI-DIAGNOSTIC',

        // === INDEX - MINI-DIAGNOSTIC MODAL ===
        'Étape 1/3': 'Step 1/3',
        'Étape 2/3': 'Step 2/3',
        'Étape 3/3': 'Step 3/3',
        ...
        'Être accompagné de A à Z (offre packagée)': 'Full A-to-Z support (packaged offer)',
        'J\'ai besoin d\'un devis personnalisé': 'I need a custom quote',
        'Je veux juste une prestation (photo/vidéo/marketing/média)': 'I just want a service (photo/video/marketing/media)',
        'Où en êtes-vous ?': 'Where are you at?',
        'J\'ai juste une idée': 'I just have an idea',
        'Je veux structurer mon projet': 'I want to structure my project',
        'Je veux devenir visible': 'I want to become visible',
        'Je veux passer un cap': 'I want to reach the next level',
        'Quel type de devis ?': 'What type of quote?',
        'Offre packagée sur mesure': 'Custom packaged offer',
        'Prestation individuelle sur devis (photo/vidéo…)': 'Individual service on quote (photo/video...)',
        'Projet hybride (accompagnement + production + média)': 'Hybrid project (support + production + media)',
        'Quelle prestation ?': 'Which service?',
        'Photo': 'Photo',
        'Vidéo': 'Video',
        'Marketing / Stratégie': 'Marketing / Strategy',
        'Média (mise en avant)': 'Media (promotion)',
        'Fermer': 'Close',
        'VOIR MON OFFRE RECOMMANDÉE': 'VIEW MY RECOMMENDED OFFER',
        'DEMANDER MON DEVIS': 'REQUEST MY QUOTE',
        'VOIR LES OPTIONS': 'VIEW OPTIONS',
        'DEMANDER UN DEVIS (RECOMMANDÉ)': 'REQUEST A QUOTE (RECOMMENDED)',
        'VOIR LES FORMULES': 'VIEW PACKAGES',
